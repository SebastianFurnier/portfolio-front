const SnowflakesBackground = () => {
  return (
    <>
      ...
      <div className="snowflake-tiny" style={{ left: '40%', animationDuration: '12s' }}></div>
      <div className="snowflake" style={{ left: '55%', animationDuration: '9s' }}></div>
      <div className="snowflake-tiny" style={{ left: '70%', animationDuration: '11s' }}></div>
      <div className="snowflake" style={{ left: '20%', animationDuration: '13s' }}></div>
      <div className="snowflake-tiny" style={{ left: '60%', animationDuration: '15s' }}></div>
      ...
      <div className="snowflake-tiny" style={{ left: '27%', animationDuration: '25s' }}></div>
      ...
      <div className="snowflake-tiny" style={{ left: '74%', animationDuration: '21s' }}></div>
      <div className="snowflake-tiny" style={{ left: '82%', animationDuration: '16s' }}></div>
